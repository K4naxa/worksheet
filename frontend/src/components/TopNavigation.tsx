    ...
    <nav className="bg-white/10 shadow-lg border-b border-white/10">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Left side - This part is static and renders immediately */}
          ...
          <div className="relative" ref={dropdownRef}>
            {isLoading || !userProfile ? (
              // Show the skeleton while loading or if profile is not available
              <ProfileButtonSkeleton />
            ) : (
              // Show the real button once data is loaded
              <>
                <button
